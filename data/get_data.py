...
def get_datasets():
    ...
    parser.add_argument("--dataset", default='permutations', type=str, required=False,
                        choices=['rotations', 'permutations', 'manypermutations', 'all'],
                        help="Either the name of the dataset (rotations, permutations, manypermutations), or `all` to download all datasets")
